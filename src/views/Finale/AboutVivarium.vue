        ...
        <div class="page-content">
            ...
            <div>
                ...
                <p>
                    ...
                    kunstiliste ja tehnoloogiliste vahendite abil kõnelda
                    ühiskonna soodumusest kapselduda kõlakodadesse. Testpubliku
                    osalusel läbiviidud läbimängudel on selgunud, et lavastusele
                    loodud struktuur on igati toimiv infomulli mõtestamiseks.
                    Publik reisib läbi teatrimaja, kuid ühtlasi ka läbi iseenese
                    sisekosmose pingevälja olukorras. Kuidas säilitada
                    kriitikameel, kui “meie” oleme nn välja joonistatud
                    ainuõigetena ja “nemad” - vaenlastena? Kuis jääda kaine
                    mõistuse juurde, kui dramaturgia on üles ehitatud
                    manipulatsioonile? Kas infomull lõhkeb ülekeemise tulemusel
                    või jääb võitjaks kurb tõdemus - “meil” ei ole just hästi,
                    aga “neil” on halvemini?
                </p>

                <p>
                    Vastandamine on iidseim vahend võimu saavutamiseks ja
                    säilitamiseks - jaga ja valitse toimib siinkohal kui
                    kellavärk. Tund aega, et hinge minna? Ei. Tund aega, et
                    radikaliseeruda.
                </p>
